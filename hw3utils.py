...
class HW3ImageFolder(torchvision.datasets.ImageFolder):
    ...
    def prepimg(self, img):
        # normalize tensorized image from [0,1] to [-1,+1]
        return (transforms.functional.to_tensor(img)-0.5)*2
    ...
    def __getitem__(self, index):
        ...
        color_image, _ = super(HW3ImageFolder, self).__getitem__(
            index)  # Image object (PIL)
        grayscale_image = torchvision.transforms.functional.to_grayscale(
            color_image)
